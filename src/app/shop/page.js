        ...
        <div className="glass-panel rounded-3xl p-6 mb-10 flex flex-col lg:flex-row gap-6 justify-between items-center border border-white/5">
          ...
          <div className="relative w-full lg:w-96 group">
            ...
            <input
              ...
              className="w-full bg-black/40 border border-white/10 hover:border-white/20 focus:border-brand-cyan/50 focus:ring-1 focus:ring-brand-cyan/20 outline-none rounded-full py-3 pl-11 pr-4 text-sm text-white placeholder-slate-500 transition-all duration-300"
            />
          </div>
          ...
          <div className="relative w-full lg:w-60 flex items-center gap-2 justify-end">
            ...
            <select
              ...
              className="bg-black/40 border border-white/10 hover:border-white/20 outline-none rounded-full py-2.5 px-4 text-xs font-semibold text-slate-300 hover:text-white transition-all cursor-pointer w-full lg:w-auto"
            >
                  ...
                  >
                    ...
                    <div className="mt-auto z-10 space-y-4">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-3 rounded-full border border-white/10 bg-white/5 hover:bg-brand-purple text-xs font-bold tracking-wider text-slate-200 hover:text-white transition-all duration-300 transform active:scale-95 hover:shadow-[0_0_15px_rgba(139,92,246,0.35)]"
                      >
